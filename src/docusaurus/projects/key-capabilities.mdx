...
An instance of <ProductName /> (sandbox solution) is created to demonstrate some of the capabilities. This document provides the [user guide](using-the-application) for the reference solution (<ProductName />).
