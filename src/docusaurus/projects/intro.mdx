...
Using a project or micro-improvement project, users can define and track a set of easy and obtainable tasks and achieve specific objectives towards the improvement of entities or organizations.
