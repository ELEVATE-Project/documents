...
A program is a structured initiative designed to achieve specific outcomes. It serves as an overarching framework under which multiple activities, such as projects, observations and survey can be organized, executed, and tracked.
...
<tr>
    <td>Program title</td>
    <td>The name that clearly indicates the focus or goal of the initiative.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Thematic focus of the program.</td>
</tr>
<tr>
    <td>Recommended for</td>
    <td>The specific user group(s) the program is intended for.</td>
</tr>
<tr>
    <td>Geography</td>
...
<tr>
    ...
    <td>Defined start and end dates</td>
</tr>
</table>
