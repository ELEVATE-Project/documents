...
<p>To learn more about accessing projects you have started, see any one of the following sections:</p>
<ul>
...
4. Optionally, you can add the following information:
    ...
    <tr>
    <td>Upload task-level evidence</td>
...
6. To save the changes, go to the project details page and click <b>Sync</b>.
