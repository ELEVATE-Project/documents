...
2. Update the task as follows:
    ...
    <td><p>To specify the project's progress, click the <b>Status</b> dropdown and select any one of the following status:</p><ul><li>Not Started</li><li>In Progress</li><li>Completed</li></ul></td>
    </tr>
    </table>
...
<td><ol><li>Click the Status dropdown.</li><li>select any one of the following status for the task:<ul><li>Not Started</li><li>In Progress</li><li>Completed</li></ul></li></ol></td>
</tr>
</table>
