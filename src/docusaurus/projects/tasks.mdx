...
Improvement projects may include one or more tasks (or actions) that you must complete. Tasks can be mandatory or non-mandatory.

<p>
<Admonition type="tip">
To identify tasks that are mandatory, look for the <i>Mandatory</i> label on the task tile.
</Admonition>
</p>
