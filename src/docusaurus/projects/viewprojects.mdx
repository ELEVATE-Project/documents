...
* Using the Project tile or the Program tile
...
To view the Projects page, click the **Project** tile on the Home page. On the Project page, you can find the following tabs:
...
## Using the Program Tile

To view the Projects page, do the following:

1. Click the **Programs** tile on the Home page to view the programs mapped to your role and location.

2. Select any program to view the projects listed under it.
