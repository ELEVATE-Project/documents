...
<details>
  ...
  <PartialExample mentored /> is an open source solution to enable a mentoring network and make experts discoverable to mentees to connect and seek guidance for professional development.
