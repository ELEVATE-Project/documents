...
If you wish to integrate a custom app, you need to understand how to use the Application Programming Interfaces exposed by the platform. To learn about APIs, see the following topics:
