...
* <a href="manageassignedsession">Managing Session That Are Assigned to Mentors</a>
...
On the My Mentoring Sessions tab, click <b>Start</b> to host sessions that you have created or the ones that have been assigned to you by a session manager.
