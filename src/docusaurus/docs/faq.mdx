...
* Assign the sessions to mentors. The assigned sessions are hosted by mentors during the scheduled time.
...
* <a href="createsession-sessionmanager">Creating Sessions</a>
* <a href="manageassignedsession">Managing the Assigned Sessions</a>
...
<p>You can sign up as a mentor after receiving the application's link from your organization through an email.</p>
<p>You can sign up as a mentee if you received:</p>
<ul>
<li>The application's link from your organization.</li>
<li>Shared session or mentor profile links from your contacts.</li>
</ul>
<p>
   <Admonition type="tip"> 
