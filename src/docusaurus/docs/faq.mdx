...
* Upload the list of users with assigned roles to the platform. 
* Manage users' requests to be a mentor. 

To learn more, see the following topics:

* <a href="bulkupload">Uploading Users to the Application</a>
* <a href="managementorrequests">Managing Requests to be a Mentor</a>
...
<ul>
<li>The application's link from your organization through an email.</li>
