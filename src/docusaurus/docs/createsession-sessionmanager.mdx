...
11. Select an option from the following boxes:
...
9. On the **Bulk upload** tab, click **Upload CSV** and select the CSV file containing the list of sessions. To view the published sessions and their session IDs, go to the **Create sessions** tab.
    ...
    <p>If the details entered in the uploaded CSV need corrections, the session status would be <i>invalid</i> and the session is not published. In such cases, refer to the status message and reupload the respective file with the updated details.</p>
    </Admonition>
    </p>
