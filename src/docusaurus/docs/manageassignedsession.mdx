...
3. On the Session list section, do any one of the following actions:
...
3. To view the list of mentees, do any one of the following actions:
...
4. To view the Edit session details page, do one of the following actions:

    * Click ![](media/sessionlist-edit.png).
