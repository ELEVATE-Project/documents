...
import SearchFilter from './_searchfilter.mdx';
...
You can view the published sessions in the Session list section.
...
From the Session list section, you can find a session using the following methods:
...
6. To update the details, do as follows:
    ...
    2. Enter the session ID in the **Session ID** column.
...
3. On the **Bulk upload** tab, click **Upload CSV** and select the CSV file containing the edited session details.
    ...
    <p>If the details entered in the uploaded CSV need corrections, the session status would be <i>invalid</i> and the session is not updated. In such cases, refer to the status message and reupload the respective file with the updated details.</p>
    </Admonition>
    </p>
...
2. Click **Manage sessions**. The Session list section appears.
    ...
    <p>
    <Admonition type="tip">
    <p>From the list, you can find sessions by:</p>
        <ul>
...
3. To delete the session, do one of the following actions:

    * Click ![](media/sessionlist-delete.png).
...
4. Click <b>Yes delete</b> on the confirmation dialog. The session is cancelled and is removed from the Session list section.
...
5. Do as follows:
    ...
    2. In the **Session ID** column, enter the session IDs of the session that you want to delete.
...
3. On the **Bulk upload** tab, click **Upload CSV** and select the CSV file containing the list of sessions to be deleted.
    ...
    <p>If the details entered in the uploaded CSV are incorrect, the session status would be <i>invalid</i> and the session will not be deleted. In such cases, refer to the status message that and reupload the CSV file with the correct details.</p>
    </Admonition>
    </p>