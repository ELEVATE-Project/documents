...
1. On the Session list section, do one of the following actions:

    * Find a session and click the **Mentee count** value. The session list page displaying the list of enrolled and invited mentees appears.
