...
3. On the **Bulk upload** tab, click **Upload CSV** and select the CSV file containing the edited session details. The session details are updated.
    ...
    <p>If the details entered in the uploaded CSV need corrections, the session status would be <i>invalid</i> and the session is not updated. In such cases, refer to the status message and upload the respective file with the updated details.</p><p> To make the necessary updates, see the <a href="bulkupload-invalidsession">Troubleshooting Invalid Messages</a> section.</p>
    </Admonition>
    </p>
...
3. On the **Bulk upload** tab, click **Upload CSV** and select the CSV file containing the list of sessions to be deleted. The session is removed from Session list section.
    ...
    <p>If the details entered in the uploaded CSV are incorrect, the session status would be <i>invalid</i> and the session will not be deleted. In such cases, refer to the status message and upload the respective file with the correct details</p><p>To make the necessary updates, see the <a href="bulkupload-invalidsession">Troubleshooting Invalid Messages</a> section.</p>
    </Admonition>
    </p>