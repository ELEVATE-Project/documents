...
The session manager can track the following information using the dashboard:
...
4. Total number and total hours of mentoring sessions conducted by a mentor along with the mentor rating.
...
<tr>
    <td>Duration</td>
    <td><ul><li><b>This month</b>: To view the sessions created and conducted in the current month.</li>
    <li><b>This week</b>: To view the sessions created and conducted in the current week.</li>
...
You can view the session details, such as name of the mentor, number of mentoring sessions conducted, time spent for the mentoring sessions in hours, and the average mentor rating.
...
3. Click **Submit** to download the table data as a CSV file.