...
* Do one of the following actions:
    ...
    * Select <b>Profile</b> from the left panel.
    * Go to the left panel ![burger menu](media/burgermenu-icon.png) and select <b>Profile</b>.
...
* Click the **View roles** link on the left panel.

* Go to the left panel ![burger menu](media/burgermenu-icon.png) and click **View roles** link.
