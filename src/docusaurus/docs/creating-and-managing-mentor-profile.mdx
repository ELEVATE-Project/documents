...
You can view the list of additional privileges such as that of a session manager or organization administrator that are assigned to you by an organization.
