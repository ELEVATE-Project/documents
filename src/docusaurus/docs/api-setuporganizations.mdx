...
<table>
  ...
  <tr>
    ...
    <li>The user's details such as user ID, name, and email.</li>
    <li>The total number of user entries.</li>
    </ul>
    <p>
    <Admonition type="tip">    
    <p>If you have specified the user's role in the request path, re-check the role if you did not obtain the details of the user you were looking for.</p>
    </Admonition>
    </p>
    </td>
  </tr>
