...
4. Enter the session information in the <b>Session title</b> and <b>Description</b> boxes.
...
7. Select an option from the following boxes:
...
8. Click <b>Publish and add link</b>. The session is published on the platform and participants can now view your session.
