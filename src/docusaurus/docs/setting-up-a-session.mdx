...
15. Before or after the session, the mentor can upload documents or add links related to the session using the 
    pre session or post session resources.

    ![](media/pre-and-post-session-resources.png)    

   
15. Click <b>Publish and Add link</b>. The session is published on the platform and mentees can now view your session.
