...
4. Enter the session information in the <b>Session title</b> box and <b>Description</b> box.  
 <p>  
        ...
        <p>The information that you need to provide can vary based on how this feature is set up by your organization. .</p>
        </Admonition>
    </p>  
...
15. <details> <summary>To upload documents or add links related to the session using the <b>Pre session</b> or <b>Post session resources</b>, click here for the following actions:</summary>

    1.  To attach files:

        1. Click <b>Attach files</b>. The <b> Add file</b> dialog box appears.

        ![](media/pre-and-post-session-resources.png)  

        2. Click <b>File Upload</b>.    

        ![](media/fileupload.png)

        3. Select the file from the <b>Windows Open</b> dialog box.

        ![](media/attachfile.png)

        4. Click <b>Add</b> to upload the selected file. The documents you have selected appears under the <b>Pre session resources</b>.

    <p>  
        <Admonition type="note">
        <p>You can upload pdfs, word documents, presentations, and links to online resources such as websites, articles, audio, and video.</p>
        </Admonition>
    </p>  

    2.   To add a link do as follows:

            1. Click <b>Add link</b>. The <b>Add link</b> dialog box appears.

            ![](media/addlink.png)

            2. Enter a name and the URL in the respective text boxes.
            3. Click <b>Add</b> to add the link.
            4. After you click <b>Publish and Add link</b> an email notification is sent to all attendees.
            
    <p>  
        <Admonition type="note">
        <p>When the mentees click on <b>More Information</b> in the email, they are redirected to the sessions page
           in the mentoring app with all the session information along with the resources. The mentees can view or download the session related documents to their local device.</p>
        </Admonition>    
    </p>

    <p>
        <Admonition type="tip" title="Post Session Resources">             
            <ul>
            <li>Follow the steps described for pre-session resources to upload files or add links for post-session resources as well.</li>
            <li>This field will be enabled only when the session is complete, allowing the mentor to add any post-session resources.</li>
            </ul>       
        </Admonition>
    </p>   
     </details>

16. Click <b>Publish and Add link</b>. The session is published on the platform and mentees can now view your session.
...
16. On the <b>Meeting link</b> tab, select a meeting platform from the <b>Add meeting link</b> menu.
...
17. Click <b>Submit</b>. The meeting information is added.
