...
The Request page allows you to manage your connections. You can view all the pending connections
and decide whether to accept or reject their request.
...
3. Do one of the following:
    ...
    * Click **Accept** to accept the request. A message appears stating that your session request has been approved.

    ![](media/sessionrequest-accept.png)

    You can share the session link with your mentee. To share the link, click **Add link** and then enter the URL 
    in the space provided. You can start the session only 10 minutes before the scheduled time.
    ...
    * Click **Reject** to reject the message request or **Cancel** to return to the session details page.
