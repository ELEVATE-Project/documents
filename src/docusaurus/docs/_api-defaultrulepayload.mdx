...
<tr>
    ...
    <td><p>This is applicable only to default rules for sessions.</p><p>If the value is set to <i>true</i>, <b>target_field</b> from the session host's profile is evaluated with the <b>requester_field</b>.</p><p>Example: Users are matched to sessions based on the languages specified on the session host's profile.</p></td>
    <td>False</td>
</tr>
<tr>
    <td>target_field</td>
