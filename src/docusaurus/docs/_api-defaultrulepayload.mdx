...
<tr>
    <td>contains</td>
    <td><p>Checks whether the target_field contains entities of requester_field.</p><p>Example: "<i>[English, Hindi]</i>" in the target_field can be matched with "<i>[English]</i>", "<i>[Hindi]</i>", or "<i>[English, Hindi]</i>" in the requester_field.</p></td>
</tr>
<tr>
    <td>containedBy</td>
