...
The mentor's details are displayed as cards and they are configurable as shown in the following figure.
...
for a session using the **chat** and **Request session** option available on the mentor card.
...
To find mentors on the my connections page, enter a keyword such as the mentor's name or the area of expertise in the Search connections box and press Enter. 
The search results appear as mentor cards.
