...
<ul>
<li>Since mentees can only send and receive message requests, only <b>Chat</b> option is available on their cards.</li>
<li>Mentors' cards have both <b>Chat</b> and <b>Request session</b> options because a mentor can send or receive message requests and session requests.
</li>
</ul>
</Admonition>
