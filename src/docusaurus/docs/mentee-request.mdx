...
* View the message request sent to the mentors whom you wish to connect with.
...
The Request page contains two tabs: (1) Message requests (2) Slot requests
...
The Message requests tab will list all the message requests sent to the mentors' whom you wish to connect with.
 ...
 Click **View Message** to open the chat window.

 ## Slot Requests

The Slot requests tab lists all the session requests you have sent to the mentors.
