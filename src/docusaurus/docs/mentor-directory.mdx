...
To find mentors on the Mentor Directory, enter a search phrase such as the mentor's name or the area of expertise in the **Search** box and press **Enter**. The search results appear as mentor profile tiles.

<details>

<summary>You can also search for mentors based on a specific category. Click here for the following actions:</summary>
...
1. To specify the search category, refer to the following table:
    ...
    <tr>
        <td>Filter</td>
        <td><ol><li>Click on <b>Filter</b>.</li><li>Select one or more filters and click <b>Apply</b>.</li><Admonition type="tip"><p>To clear filters, do one of the following actions:</p><ul><li>Clear the filter checkbox.</li><li>Click <b>Clear all</b> to clear all the applied filters.</li></ul></Admonition></ol></td>
    </tr>
    </table>
...
<Admonition type="tip">   
<p>A default mentee role is assigned to every registered user on the platform.</p>
</Admonition>
