...
* Do the following actions:
    ...
    2. Enter the search keyword. Based on the search keyword, the search result displays mentor profile tiles.

    ![](media/searchmentors.png)

If the search result displays multiple mentor profile tiles, you can find the respective mentor using the following ways:

* View the search results on different pages by clicking the **Next** or **Previous** buttons.

* Change the number of search results listed on the page using the **Items per page** dropdown.

* Filter the search results as follows:
...
You can view the list of additional privileges such as that of a session manager or organization administrator that are assigned to a mentor by an organization.
