...
* On <b>desktop</b>: Select <b>Mentors</b> from the left panel. The mentor directory appears.
...
* On <b>mobile</b>: Go to the application and click the <b>Mentors</b> tab located at the bottom of the screen.
