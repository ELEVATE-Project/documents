...
The mentor directory lists the mentors profiles in an alphabetical order. Using the mentor directory you can perform the following:

* View all the mentors existing on the platform.

* View all the mentors' profile. To do this, click anywhere on the mentors card.
...
Enter the search criteria such as Mentor name or Area of Expertise.  Based on the selected category, the search results appear as mentor cards tiles.
...
1. Click the <b>Filter</b> option on the upper-right corner of the page.
...
1. To specify the search category, refer to the following table:
    ...
    <tr>
        <td>Filter</td>
        <td><ol><li>Click on <b>Filter</b>.     
                        
        </li>
        <li>Select one or more filters and click <b>Apply</b>.</li><Admonition type="tip"><p>To clear filters, do one of the following actions:</p><ul><li>Clear the filter checkbox.</li><li>Click <b>Clear all</b> to clear all the applied filters.</li></ul></Admonition></ol></td>
    </tr>
    </table>

     

2. Enter the search keyword. Based on the selected category, the search results appear as mentor cards tiles.
...
1. On the Mentor Directory, click on the name or designation of the mentor whose profile you wish to view.
...
Using the **Chat** option, a mentee can send messages to the mentor. The mentor can accept or reject the message request.
...
<Admonition type="info">
   ...
   <li>The mentee can send only one message till your message request is accepted.</li>
    ...
    <li>The mentee will be able to send a message to the mentor again only when the mentor has either accepted the request or rejected it. If the message gets rejected,
...
## Sending a Session Request to the Mentor  ###in progress

You can request for a session on the mentor's directory using the Request session option.
