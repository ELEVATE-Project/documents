...
You can gain oversight of the mentoring program at an organization by:

* Creating (Public or Private) sessions.
* Assigning the sessions to mentors. The assigned sessions are hosted by mentors during the scheduled time.
