...
The <PartialExample mentored /> application has a multi-tenant architecture, and organizations can host their own instance of the application. Organizations can manage access to their sessions and mentors for mentees from other organizations.
