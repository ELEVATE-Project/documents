...
Organizations can also configure policies to:

* Provide session managers conditional access to other organizations’ mentors and mentees.

* Manage whether the organization’s mentors and mentees are visible to session managers of other organizations.

For example, if the mentor access is denied, session managers cannot view and assign sessions to the mentors. If the mentee access is denied, session managers cannot view and invite mentees.

Organizations can also configure policies to provide session managers conditional access to the organization's mentors and mentees.

<p>  
    <Admonition type="note">
    <p>The policies configured for the following are not interdependent and can be configured individually as needed:</p>
    <ul>
    <li>Access to mentor profiles</li>
    <li>Access to sessions</li>
    <li>Session manager's access to mentors</li>
    <li>Session manager's access to mentees</li>
    </ul>
    </Admonition>
</p>
