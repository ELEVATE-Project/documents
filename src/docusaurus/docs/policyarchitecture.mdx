...
The <PartialExample mentored /> application has a multi-tenant architecture, and adopters can set up the application using the microservices and create multiple organizations. Organizations can manage access to their sessions and mentors for mentees from other organizations.
