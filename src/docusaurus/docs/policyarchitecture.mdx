...
* The **domain name** in the email ID of registered users. 
    ...
    <p>  
        ...
        <p>If the email ID does not contain a domain name, the back end recognizes the user's organization as <b>Default</b> organization.</p>
        </Admonition>
    </p>
...
* The organization that uploaded users to the application. 
    ...
    <p>  
        <Admonition type="note">
        <p>If their email IDs do not contain a domain name, the back end still recognizes the user belonging to that organization.</p>
        </Admonition>
    </p>
