...
2. To modify your current profile information, click <b>Edit profile</b> on the Profile page.
...
4. Click <b>Submit</b>. Your profile is updated.
...
You can view the list of additional roles such as that of a mentor, session manager, or organization administrator that are assigned to you by an organization.
