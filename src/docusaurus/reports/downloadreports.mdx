...
<p>
    ...
    <p>To download the big number reports, point to the report that you want to download.
     The download icon with three dots appears as shown in the following figure.</p>
    </Admonition>
    </p>
...
<p>
    <Admonition type="tip">
    <p>You can access individual reports either by clicking the specific report on the dashboard
or from the report collections available on the home page.</p>
    </Admonition>
    </p>

* Click the **Download** option given at the lower-right corner of the report page as shown in the following figure.
