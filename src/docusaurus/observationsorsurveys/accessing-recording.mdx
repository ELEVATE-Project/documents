...
5. Click Karnataka. The list of Observations that are mapped to your profile appears.
  ...
  <p>
    ...
    Since the scope is restricted to your profile state in this example, you will not be able to add any more states.
...
8. Click **Save** to save your response. You can continue to answer remaining questions or do it later when you have time. 

9. Click the Question Map icon ![](media/qmapicon.png) to see if all questions are answered.

10. After saving your answers on all pages, click **Submit**.
