...
On the Survey Reports page, you can view the list of submitted reports and view the responses that were saved at the time of submission.

**To access survey reports, do as follows:**
...
2. On the Questions window, select one or more questions for which you want to view the response and select **Apply Filter**.
    ...
    <Admonition type="tip">
    To remove the applied filter, Click the <b>Filter</b> button and select <b>Apply Filter</b>.
    </Admonition>
