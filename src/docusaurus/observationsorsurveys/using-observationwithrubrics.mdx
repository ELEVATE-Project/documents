...
The framework has certain parameters on which the entities are assessed based on a rubric-based scoring system. Each criterion has a rating level mapped to different levels of performance, such as Excellent, Good, Satisfactory, and so on.
...
**Criteria-based questions**: These are specific questions within the sections to evaluate the performance of an entity.
